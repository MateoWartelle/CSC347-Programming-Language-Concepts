...
object dynamic {
  ...
  def newEnglish () : Internationalization = {
    class InternationalizationX extends Internationalization {
	  override def greet(name : String) : String = {
	  ("Hello " + name)
	  }
	}
	  var x : Internationalization = new InternationalizationX
	  x
  }
  ...
  def newFrench () : Internationalization = {
   class InternationalizationXX extends Internationalization {
		  override def greet(name : String) : String = {
		  ("Bonjour " + name)
		  }
		}
		  var x : Internationalization = new InternationalizationXX
		  x
  }
}
